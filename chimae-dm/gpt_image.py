...
# ── 브랜드 / 설계사 정보 ──
# ⚠️ 준법 주의: 롯데손해보험 공식 로고·CI 는 회사 승인 없이 재현 금지.
#    아래는 '롯데 레드' 브랜드 톤만 차용하고, 서명은 설계사 본인 정보로 표기한다.
AGENT_NAME = "롯데손해보험 LP 권용준"
...
def build_prompt(spec: dict) -> str:
    ...
    return (
        ...
        f"· 맨 하단 우측에 작고 단정한 회색 서명: '{AGENT_NAME}'\n"
        f"{ad_line}\n"
        "주의: 롯데손해보험 공식 로고/심볼/워드마크는 절대 그리지 말 것(상표권). "
        "브랜드 '느낌'만 컬러와 톤으로 표현. 사람 얼굴 클로즈업이나 실사 사진은 쓰지 말고, "
