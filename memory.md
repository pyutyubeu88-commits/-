...
### [2026-08-01] 우규역삼점(이자카야) 사장님 통화 — 경쟁 컨설팅 그룹 영업 시도 거절
- 상황: 모임장이 소개한 외부 컨설턴트 2명(그중 1명)이 매장 방문 → 간판 등 전방위로 "다 문제있다"식 지적, 5만원/월 구독형 유료회원제(사장님들 대상 손님 연결 명목) 영업 시도
- 사장님이 용준 씨(현재 진행 중인 AI 컨설팅) 작업물을 보여주자 "이런 거 필요 없다"며 부정적 반응 → 사장님 욕심 없다는 말에 화까지 냄
- ★사장님 명확한 입장★: 큰 욕심 없음, 목표는 "적자만 안 보면 됨" (현재 생활비 나오는 수준, 월 250~300만원이면 만족), 그 이상은 플러스면 좋지만 필수 아님 → 외부 컨설턴트 제안 거절, 계속 용준 씨와 진행 원하며 신뢰 재확인
- 사장님 마케팅 성향: 당근마켓 등 신규 채널 전혀 안 씀(신뢰 부족+환불 리스크 우려), 지금까지 정석대로 문자·카톡 정도만 사용 → 공격적/과한 영업식 접근 원하지 않음
- 시사점: 컨설팅 방향은 "오버클레임 없이 현재 방식 유지 + 매출 소폭 상승분을 보너스로 어필" 톤 유지할 것. 무리한 확장 제안 금지, 신뢰 기반 저강도 접근 유지
