...
- [2026-07-31] ★모임명 변경: 기브넷(GiveNet) → 도도넷★ — "도도남/도도녀=도움주고 도움받는 사람" 워드플레이. 단 "도도하다(새침하다)"는 기존 의미가 더 익숙해서 오해 소지 있음을 인지하고, 소개글 첫 줄에서 "도도한 게 아니라 도움 주고받는 거예요"로 반전 해소하는 후킹 카피로 역이용. 도도남/도도녀는 회원 뱃지 칭호(이달의 도도남/도도녀)로도 활용
- 매뉴얼 `givenet-meetup-manual.md` v1.1로 전체 업데이트(브랜드명 전면 교체 완료), 이미지 프롬프트는 아직 최종본 미확정(사람 중심 버전 결과 대기 중)
